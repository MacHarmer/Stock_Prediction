...
MODEL_INFO = {
        ...
        "keys": ["AAL", "DAL", "TSLA", "DEXJPUS", "DEXUSUK", "DEXCHUS", "SP500", "DJIA", "VIXCLS"],
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["AAL", "DAL", "TSLA", "DEXJPUS", "DEXUSUK", "DEXCHUS", "SP500", "DJIA", "VIXCLS"]]
}
